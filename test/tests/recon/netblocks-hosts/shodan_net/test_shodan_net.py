...
# =====================================================================================
class TestShodanNetworkEnumerator(ModuleTestCase):
    '''
    Tests the Shodan Network Enumerator Module
    '''
    ...
    # =====================================================================================
    VERBOSITY = 1
    FQN = "recon/netblocks-hosts/shodan_net"
    TEST_RESULTS_FILENAME = "test_results.json"
    TEST_NETBLOCK = "45.77.63.219/24"
    ...
    def test_successful_run(self):
        ...
        self._module._test_results_file = self.test_results_path
        self._module.run([self.TEST_NETBLOCK])

        self.assertInOutput(r".*Target \(1 of 1\).*")
        self.assertInOutput(r".*Hosts discovered: 100")
        self.assertInOutput(r".*Ports discovered: 158")
